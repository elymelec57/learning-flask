...
# Cargamos la clave desde Config directamente para evitar errores de scope
key = Config.MS_TRANSLATOR_KEY
genai_client = None
if key:
    genai_client = genai.Client(api_key=key)

# El modelo "Flash" es ideal para APIs por su velocidad. 
# Nota: gemini-2.0-flash es el modelo estable más reciente.
